 ...
 * have our application access Spotify to play, pause, and update the currently playing music, search for song recommendations based
 * on a song title, get a list of song recommendations, and display the recommendations with the option to remove any recommendations from the current list of recommendations, 
